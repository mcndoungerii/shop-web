          ...
          <b-colxx xxs="12">
            ...
            <b-modal id="modalright" ref="modalright" :title="'Sale Details'" class="modal-right">
              <div v-if="selectedItem">
                ...
                <div v-if="selectedItem.amountPaid" class="mb-3 pb-3 border-bottom border-bottom">
                  <div class="pl-0 mb-15 d-flex flex-grow-1 min-width-zero">
                    <div
                      class="p-0 card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center"
                    >
                ...
                <div v-if="selectedItem.discount" class="mb-3 pb-3 border-bottom border-bottom">
                  <div class="pl-0 mb-15 d-flex flex-grow-1 min-width-zero">
                    <div
                      class="p-0 card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center"
                    >
                ...
                <div v-if="selectedItem.change" class="mb-3 pb-3 border-bottom border-bottom">
                  <div class="pl-0 mb-15 d-flex flex-grow-1 min-width-zero">
                    <div
                      class="p-0 card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center"
                    >
            ...
            <!-- Add Sale Modal -->
            <modal height="auto" :scrollable="true" :adaptive="true" name="viewSaleModal">
...
import DataListItem from "components/Listing/Sale/DataListItem";
import saleApi from "../../../api/sale";
import customerApi from "../../../api/customer";
import userApi from "../../../api/user";
import productApi from "../../../api/product";
import saleDetailApi from "../../../api/saleDetail";
...
export default {
  ...
  data() {
    return {
      ...
      selectedSaleDetail: {},
      saleDetails: [],
      selectedSaleDetailProduct: null
    };
  },
  methods: {
    loadItems() {
    ...
    showViewSale() {
      ...
      this.$modal.show("viewSaleModal");
      this.$refs.modalright.hide();
    },
    deleteSaleDetail(index) {
      let items = [];
      items.push(this.newItem.saleDetails[index].id);
      saleDetailApi
        .delete(items)
        .then(res => {
          this.processing = false;
          this.newItem.saleDetails.splice(index, 1);
          this.$notify(
            "success",
    ...
    addSaleDetail() {
      let data = Object.assign({}, this.selectedSaleDetail);
      data.product = this.selectedSaleDetailProduct.id;
      data.sale = this.newItem.id;
      saleDetailApi
        .create(data)
        .then(res => {
          this.processing = false;
          ...
          this.loadItems();
          this.newItem.saleDetails.push(res.data);
          this.$modal.hide("modalAddSaleDetail");
        })
        .catch(error => {
          this.processing = false;
          console.log(error);
