              ...
              <div v-if="selectedItem">
                  ...
                  <div v-if="selectedItem.id" class="d-flex flex-grow-1 min-width-zero mt-3 mb-3">
                    ...
                    >
                      <div class="min-width-zero">
                        <p class="mb-1 text-muted text-small">Payment ID</p>
                        <p class="list-item-heading mb-1">{{selectedItem.id}}</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div v-if="selectedItem.sale" class="mb-3 pb-3 border-bottom border-bottom">
                  <div class="pl-0 mb-15 d-flex flex-grow-1 min-width-zero">
                    ...
                    >
                      <div class="w-40 w-sm-100">
                        <p class="mb-1 text-muted text-small">Sale (Total)</p>
                        <p class="list-item-heading mb-1">{{selectedItem.sale.total}}</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="pl-0 mb-15 d-flex flex-grow-1 min-width-zero">
                    ...
                    >
                      <div class="w-40 w-sm-100">
                        ...
                        >{{ selectedItem.status?'PAID':'UNPAID' }}</b-badge>
                      </div>
                    </div>
                  </div>
                </div>
                <div v-if="selectedItem.due" class="mb-3 pb-3 border-bottom border-bottom">
                  <div class="pl-0 mb-15 d-flex flex-grow-1 min-width-zero">
                    <div
                      class="p-0 card-body align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero align-items-lg-center"
                    >
                      <div class="w-40 w-sm-100">
                        <p class="mb-1 text-muted text-small">Due</p>
                        <p class="list-item-heading mb-1">{{selectedItem.due}}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div v-if="selectedItem.createdAt" class="mb-3 pb-3 border-bottom border-bottom">
                  <div class="pl-0 mb-15 d-flex flex-grow-1 min-width-zero">
                    ...
                    >
                      <div class="w-40 w-sm-100">
                        <p class="mb-1 text-muted text-small">Payment Created</p>
...
import DataListItem from "components/Listing/Payment/DataListItem";
  ...
  methods: {
    loadItems() {
      ...
      if (this.apiUrl !== undefined)
        paymentApi.list(this.apiUrl).then(res => {
