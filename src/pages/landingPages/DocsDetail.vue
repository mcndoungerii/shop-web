<template>
    <div>
        <div class="section home subpage">
            <piaf-hero-sub :title="$t('lp.content.title')" :detail="$t('lp.content.detail')"/>
        </div>
        <div class="section" id="firstContent">
            <b-container>
                ...
                <b-row class="mt-4">
                    <b-colxx xxs="12" md="6" class="mb-3">
                        <img alt="library app" class="depth-1 img-fluid semi-rounded" src="/assets/img/landing-page/application-chat.jpg" />
                    </b-colxx>
                    <b-colxx xxs="12" md="6" class="mb-3">
                        <img alt="library app" class="depth-1 img-fluid semi-rounded" src="/assets/img/landing-page/application-survey.jpg" />
                    </b-colxx>
                </b-row>
                <piaf-feedback :message="$t('lp.feedback.default')" :like="$t('lp.feedback.like')" :dislike="$t('lp.feedback.dislike')"/>
            </b-container>
        </div>
...
import PiafFeedback from 'components/LandingPage/Feedback'
import PiafNewsletter from 'containers/LandingPage/Newsletter'
